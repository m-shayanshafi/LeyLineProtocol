...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f3ebf82acf8, const void *arg_0x7f3ebf829020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f3ebf7a9618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f3ebf5628e8), 
int (*key_eq_fn)(void *arg_0x7f3ebf5610c8, void *arg_0x7f3ebf561368));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f3ebf35f610, int arg_0x7f3ebf35f878);
static double RandomUniform(void );
...
# 4 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine.h"
...
typedef nx_struct LeyLineHelloMsg {
  nx_uint16_t nodeid;
} __attribute__((packed)) LeyLineHelloMsg;
...
typedef nx_struct LeyLineJoinReqMsg {
  nx_uint16_t nodeid;
} __attribute__((packed)) LeyLineJoinReqMsg;
...
} __attribute__((packed)) LeyLineBuildMsg;
...
} __attribute__((packed)) LeyLineBuildAck;
...
typedef nx_struct BackPropagationMsg {
  ...
  nx_uint16_t nodeCount;
} __attribute__((packed)) BackPropagationMsg;
...
typedef nx_struct RTBroadcast {
  ...
  nx_uint16_t predecessor;
  nx_uint16_t successor;
} __attribute__((packed)) RTBroadcast;
...
typedef nx_struct IncorpReq {
  ...
  nx_uint16_t predecessor;
  nx_uint16_t successor;
} __attribute__((packed)) IncorpReq;
...
typedef nx_struct IncorporateNodeMsg {
  nx_uint16_t predecessor;
  nx_uint16_t successor;
} __attribute__((packed)) IncorporateNodeMsg;
...
typedef nx_struct ChangeSuccessorMsg {
  ...
  nx_uint16_t predecessor;
  nx_uint16_t nodeCount;
} __attribute__((packed)) ChangeSuccessorMsg;
...
typedef nx_struct AuthSINMsg {
  nx_uint16_t nodeCount;
} __attribute__((packed)) AuthSINMsg;
...
typedef nx_struct IntLineBuiltMsg {
  nx_uint8_t built;
} __attribute__((packed)) IntLineBuiltMsg;
...
typedef nx_struct AssignAddressMsg {
  ...
  nx_uint8_t skipBy;
  nx_uint16_t src;
} __attribute__((packed)) AssignAddressMsg;
...
typedef nx_struct IntAddressCompleteMsg {
  nx_uint8_t previousAddr;
  nx_uint16_t src;
} __attribute__((packed)) IntAddressCompleteMsg;
...
typedef TMilli LeyLine25nodeTestM$FirstTimer$precision_tag;
typedef TMilli LeyLine25nodeTestM$MilliTimer$precision_tag;
typedef TMilli LeyLine_M$BackPropTimer$precision_tag;
typedef TMilli LeyLine_M$HelloMsgTimer$precision_tag;
typedef TMilli LeyLine_M$AppTimer$precision_tag;
typedef TMilli LeyLine_M$LeyLineBuildTimer$precision_tag;
typedef TMilli LeyLine_M$LeyLineAckTimer$precision_tag;
...
enum AMQueueP$__nesc_unnamed4332 {
  AMQueueP$NUM_CLIENTS = 17U
};
...
static void LeyLine25nodeTestM$SplitControl$startDone(error_t error);
# 60 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Boot.nc"
static void LeyLine25nodeTestM$Boot$booted(void );
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine25nodeTestM$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void LeyLine25nodeTestM$FirstTimer$fired(void );
#line 83
static void LeyLine25nodeTestM$MilliTimer$fired(void );
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
LeyLine25nodeTestM$Receive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 104 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static error_t LeyLine_M$SplitControl$start(void );
#line 130
static error_t LeyLine_M$SplitControl$stop(void );
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$SubSend$sendDone(
#line 103
message_t * msg, 
...
LeyLine_M$HelloReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$AssignAddressMsgSend$sendDone(
#line 103
message_t * msg, 
...
LeyLine_M$LeyLineAckReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 113 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static void LeyLine_M$AMControl$startDone(error_t error);
#line 138
static void LeyLine_M$AMControl$stopDone(error_t error);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$HelloSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$RTBroadcastSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$ChangeSuccessorSend$sendDone(
#line 103
message_t * msg, 
...
LeyLine_M$JoinReqReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t LeyLine_M$AMSend$send(
# 12 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
am_id_t arg_0x7f3ebed11020, 
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 110
static void LeyLine_M$AMSend$default$sendDone(
# 12 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
am_id_t arg_0x7f3ebed11020, 
...
error_t error);
#line 110
static void LeyLine_M$JoinReqSend$sendDone(
#line 103
message_t * msg, 
...
LeyLine_M$AssignAddressMsgReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$LeyLineAckSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$SINSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$AddrBroadcastSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$BackPropTimer$fired(void );
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
LeyLine_M$BackPropagationReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$LeyLineBuildReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$IncorpAckReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$Receive$default$receive(
# 13 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
am_id_t arg_0x7f3ebed10158, 
# 71 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
message_t * msg, 
void * payload, 
...
LeyLine_M$RTBroadcastReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$IncorpNodeReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$HelloMsgTimer$fired(void );
#line 83
static void LeyLine_M$AppTimer$fired(void );
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$IncorpReqSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$BackPropagationSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$LeyLineBuildSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$IncorpNodeSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$IntAssignAddressCompleteSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void LeyLine_M$IntLineBuiltMsgSend$sendDone(
#line 103
message_t * msg, 
...
LeyLine_M$ChangeSuccessorReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$AuthSINSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$LeyLineBuildTimer$fired(void );
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
LeyLine_M$AuthSINReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$IntAssignAddressCompleteReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$AddrBroadcastReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$LeyLineAckTimer$fired(void );
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$IncorpAckSend$sendDone(
#line 103
message_t * msg, 
...
LeyLine_M$IncorpReqReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
LeyLine_M$IntLineBuiltMsgReceive$receive(
#line 71
message_t * msg, 
void * payload, 
...
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$Send$sendDone(
#line 96
message_t * msg, 
...
enum SimSchedulerBasicP$__nesc_unnamed4333 {
...
# 104 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static error_t LeyLine25nodeTestM$SplitControl$start(void );
#line 130
static error_t LeyLine25nodeTestM$SplitControl$stop(void );
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t LeyLine25nodeTestM$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine25nodeTestM$FirstTimer$startPeriodic(uint32_t dt);
#line 78
static void LeyLine25nodeTestM$FirstTimer$stop(void );
# 23 "LeyLine25nodeTestM.nc"
message_t LeyLine25nodeTestM$pkt[1000];
message_t *LeyLine25nodeTestM$p_pkt[1000];

uint16_t LeyLine25nodeTestM$src[1000];
uint16_t LeyLine25nodeTestM$dest[1000];
uint16_t LeyLine25nodeTestM$numberNodes[1000];
uint16_t LeyLine25nodeTestM$addressSpace[1000];
uint16_t LeyLine25nodeTestM$skipby[1000];
uint16_t LeyLine25nodeTestM$myAddress[1000];
uint16_t LeyLine25nodeTestM$noTimes[1000];
uint16_t LeyLine25nodeTestM$maxTimes[1000];


static inline void LeyLine25nodeTestM$Boot$booted(void );
...
static inline void LeyLine25nodeTestM$SplitControl$startDone(error_t err);
#line 77
static inline void LeyLine25nodeTestM$FirstTimer$fired(void );
#line 103
static inline void LeyLine25nodeTestM$MilliTimer$fired(void );
#line 135
static inline void LeyLine25nodeTestM$AMSend$sendDone(message_t *bufPtr, error_t error);





static inline message_t *LeyLine25nodeTestM$Receive$receive(message_t *bufPtr, void *payload, uint8_t len);
# 113 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static void LeyLine_M$SplitControl$startDone(error_t error);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t LeyLine_M$SubSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$AssignAddressMsgSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 104 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static error_t LeyLine_M$AMControl$start(void );
#line 130
static error_t LeyLine_M$AMControl$stop(void );
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t LeyLine_M$HelloSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$RTBroadcastSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$ChangeSuccessorSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 126 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Packet.nc"
static 
#line 123
void * 


LeyLine_M$Packet$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void LeyLine_M$AMSend$sendDone(
# 12 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
am_id_t arg_0x7f3ebed11020, 
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
message_t * msg, 
...
error_t error);
#line 80
static error_t LeyLine_M$JoinReqSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$LeyLineAckSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$SINSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$AddrBroadcastSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$BackPropTimer$startOneShot(uint32_t dt);
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$HelloMsgTimer$startOneShot(uint32_t dt);
#line 73
static void LeyLine_M$AppTimer$startOneShot(uint32_t dt);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t LeyLine_M$IncorpReqSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$BackPropagationSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$LeyLineBuildSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$IncorpNodeSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$IntAssignAddressCompleteSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$IntLineBuiltMsgSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t LeyLine_M$AuthSINSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void LeyLine_M$LeyLineBuildTimer$startOneShot(uint32_t dt);
#line 64
static void LeyLine_M$LeyLineAckTimer$startPeriodic(uint32_t dt);
#line 78
static void LeyLine_M$LeyLineAckTimer$stop(void );
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t LeyLine_M$IncorpAckSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 70 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
int LeyLine_M$counter[1000];
int LeyLine_M$nodeCount[1000];
bool LeyLine_M$busy[1000];
bool LeyLine_M$starterNode[1000];
bool LeyLine_M$amIntersection[1000];
bool LeyLine_M$addressBroadcasted[1000];
int LeyLine_M$myAddress[1000];
int LeyLine_M$skipBy[1000];
int LeyLine_M$addressSpace[1000];
int LeyLine_M$tempAddr[1000];

message_t LeyLine_M$hello[1000];
message_t LeyLine_M$joinreq[1000];
message_t LeyLine_M$rtbroadcast[1000];
message_t LeyLine_M$incorpreq[1000];
message_t LeyLine_M$startLine[1000];
message_t LeyLine_M$leylineAck[1000];
message_t LeyLine_M$backPropMsg[1000];
message_t LeyLine_M$changeSucc[1000];
message_t LeyLine_M$incorpNode[1000];
message_t LeyLine_M$incorpACK[1000];
message_t LeyLine_M$authSIN[1000];
message_t LeyLine_M$SIN[1000];
message_t LeyLine_M$intLineBuiltMsg[1000];
message_t LeyLine_M$assignAddrMsg[1000];
message_t LeyLine_M$assignAddrComp[1000];

message_t LeyLine_M$app_msg_[1000];
message_t LeyLine_M$p_leyline_msg_[1000];
message_t LeyLine_M$addrBroadcastMsg[1000];
message_t *LeyLine_M$p_app_msg_[1000];


LeyLineShortcutTable LeyLine_M$shortcutTable[1000][MAX_NEIGHBOR_ENTRIES];

am_addr_t LeyLine_M$dest[1000];
am_addr_t LeyLine_M$SINnext[1000];
am_addr_t LeyLine_M$latestRTFrom[1000];
bool LeyLine_M$onCore[1000];
bool LeyLine_M$onIntersection[1000];
bool LeyLine_M$amCoreLeaf[1000];
bool LeyLine_M$leftDone[1000];
bool LeyLine_M$rightDone[1000];
bool LeyLine_M$waitingJoinReq[1000];
bool LeyLine_M$SINMode[1000];
bool LeyLine_M$waitingforAck[1000];
bool LeyLine_M$amSrc[1000];

uint16_t LeyLine_M$myNode[1000];
int LeyLine_M$neighborCount[1000];

LeyLineRoutingTable LeyLine_M$routingTable[1000];

static void LeyLine_M$sendHelloMsg(void );

static void LeyLine_M$sendIncorpAckMsg(am_addr_t destination);
static inline uint16_t LeyLine_M$getNeighbor(uint16_t prevNeighbor);
static inline void LeyLine_M$markShortcut(uint16_t mac, uint16_t addr);
static inline void LeyLine_M$sendIncorpReq(am_addr_t destination, am_addr_t predecessor, am_addr_t successor);
static void LeyLine_M$sendLeyLineBuildMsg(am_addr_t destination);
static void LeyLine_M$sendBackPropogation(am_addr_t predecessor);
static void LeyLine_M$sendRTBroadcast(void );
static inline void LeyLine_M$incorporateNode(uint16_t node);


static void LeyLine_M$sendAuthSINMsg(void );
static void LeyLine_M$sendSINPacket(uint16_t node);
static void LeyLine_M$sendIntLineBuiltMsg(void );
static void LeyLine_M$sendAssignAddressMsg(am_addr_t node);
static void LeyLine_M$sendIntAssignAddressComplete(uint16_t addr, uint16_t src);
static am_addr_t LeyLine_M$get_next_hop(am_addr_t destination);
static inline void LeyLine_M$printRouteTable(void );
static void LeyLine_M$sendAddrBroadcast(void );

static inline error_t LeyLine_M$SplitControl$start(void );
#line 167
static inline error_t LeyLine_M$SplitControl$stop(void );
...
static am_addr_t LeyLine_M$get_next_hop(uint16_t destination);
#line 257
static inline error_t LeyLine_M$AMSend$send(am_id_t id, am_addr_t addr, message_t *msg, uint8_t len);
#line 331
static inline void LeyLine_M$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err);
#line 347
static inline message_t *LeyLine_M$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len);



static inline void LeyLine_M$SubSend$sendDone(message_t *msg, error_t error);





static inline message_t *LeyLine_M$SubReceive$receive(message_t *p_msg, 
void *payload, uint8_t len);
#line 415
static inline void LeyLine_M$AMControl$startDone(error_t err);
#line 427
static inline void LeyLine_M$LeyLineBuildTimer$fired(void );
...
static void LeyLine_M$sendHelloMsg(void );
#line 446
static inline void LeyLine_M$HelloSend$sendDone(message_t *msg, error_t error);
#line 462
static inline message_t *LeyLine_M$HelloReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 485
static inline void LeyLine_M$JoinReqSend$sendDone(message_t *msg, error_t error);




static inline void LeyLine_M$HelloMsgTimer$fired(void );
#line 515
static inline void LeyLine_M$BackPropTimer$fired(void );
#line 533
static inline message_t *LeyLine_M$JoinReqReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 629
static inline void LeyLine_M$LeyLineAckTimer$fired(void );
...
static void LeyLine_M$sendLeyLineAck(am_addr_t destination);
#line 652
static inline message_t *LeyLine_M$LeyLineBuildReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 712
static inline void LeyLine_M$markShortcut(uint16_t mac, uint16_t address);





static inline uint16_t LeyLine_M$getNeighbor(uint16_t mac);
#line 736
static void LeyLine_M$sendLeyLineBuildMsg(am_addr_t destination);
#line 771
static void LeyLine_M$sendRTBroadcast(void );
#line 785
static inline message_t *LeyLine_M$RTBroadcastReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 812
static inline void LeyLine_M$sendIncorpReq(am_addr_t destination, am_addr_t predecessor, am_addr_t successor);
#line 825
static inline void LeyLine_M$IncorpReqSend$sendDone(message_t *msg, error_t error);
...
static inline message_t *LeyLine_M$IncorpReqReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 862
static void LeyLine_M$sendIncorpAckMsg(am_addr_t destination);
#line 889
static inline message_t *LeyLine_M$LeyLineAckReceive$receive(message_t *msg, void *payload, uint8_t len);
...
static inline void LeyLine_M$incorporateNode(uint16_t node);
#line 1010
static inline void LeyLine_M$sendChangeSuccessorMsg(uint16_t node);
#line 1034
static inline void LeyLine_M$RTBroadcastSend$sendDone(message_t *msg, error_t error);
...
static inline void LeyLine_M$AMControl$stopDone(error_t err);





static inline void LeyLine_M$LeyLineBuildSend$sendDone(message_t *msg, error_t error);
...
static inline void LeyLine_M$LeyLineAckSend$sendDone(message_t *msg, error_t error);



static inline void LeyLine_M$BackPropagationSend$sendDone(message_t *msg, error_t error);



static inline void LeyLine_M$ChangeSuccessorSend$sendDone(message_t *msg, error_t error);



static inline void LeyLine_M$IncorpNodeSend$sendDone(message_t *msg, error_t error);



static void LeyLine_M$IncorpAckSend$sendDone(message_t *msg, error_t error);





static inline void LeyLine_M$AuthSINSend$sendDone(message_t *msg, error_t error);



static inline void LeyLine_M$SINSend$sendDone(message_t *msg, error_t error);



static inline void LeyLine_M$IntLineBuiltMsgSend$sendDone(message_t *msg, error_t error);



static inline void LeyLine_M$AssignAddressMsgSend$sendDone(message_t *msg, error_t error);





static inline void LeyLine_M$IntAssignAddressCompleteSend$sendDone(message_t *msg, error_t error);




static inline void LeyLine_M$AddrBroadcastSend$sendDone(message_t *msg, error_t error);




static inline message_t *LeyLine_M$BackPropagationReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1169
static inline message_t *LeyLine_M$ChangeSuccessorReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1191
static inline message_t *LeyLine_M$IncorpNodeReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1218
static message_t *LeyLine_M$IncorpAckReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1257
static inline message_t *LeyLine_M$AuthSINReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1280
static inline message_t *LeyLine_M$SINReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1350
static inline message_t *LeyLine_M$IntLineBuiltMsgReceive$receive(message_t *msg, void *payload, uint8_t len);
...
static inline message_t *LeyLine_M$AssignAddressMsgReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1412
static inline message_t *LeyLine_M$IntAssignAddressCompleteReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1451
static void LeyLine_M$sendIntLineBuiltMsg(void );
...
static inline void LeyLine_M$printRouteTable(void );
#line 1517
static inline void LeyLine_M$printShortcutTable(void );
#line 1538
static void LeyLine_M$sendAddrBroadcast(void );
#line 1558
static inline message_t *LeyLine_M$AddrBroadcastReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 1577
static inline void LeyLine_M$AppTimer$fired(void );
# 46 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/GeneralIO.nc"
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
...
/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue_entry_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue[1000][17];
uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$cancelMask[1000][17 / 8 + 1];
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static error_t /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static error_t /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static error_t /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$Send$sendDone(message_t *m, error_t err);
...
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 75
...
inline static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
#line 103
inline static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 11);
  return /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$JoinReqSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 189 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void *TossimActiveMessageC$Packet$getPayload(message_t *msg, uint8_t len)
#line 189
{
  if (len <= 28) {
...
# 126 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Packet.nc"
inline static void * LeyLine_M$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 462 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline message_t *LeyLine_M$HelloReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 462
{

  LeyLineJoinReqMsg *pktToSend = (LeyLineJoinReqMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$joinreq[sim_node()], sizeof(LeyLineJoinReqMsg ));
  uint8_t accept = TOS_NODE_ID;

#line 466
  if (LeyLine_M$onCore[sim_node()] || LeyLine_M$onIntersection[sim_node()]) {
      accept = 0;
    }
  if (accept) {
...
#line 471
      LeyLine_M$dest[sim_node()] = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);


      __nesc_hton_uint16(pktToSend->nodeid.nxdata, TOS_NODE_ID);


      if (LeyLine_M$JoinReqSend$send(LeyLine_M$dest[sim_node()], &LeyLine_M$joinreq[sim_node()], sizeof(LeyLineJoinReqMsg )) == SUCCESS) {

          sim_log_debug(172U, "Leyline", "Join Req Sent to %u...\n", LeyLine_M$dest[sim_node()]);
        }
    }
  return msg;
}
...
#line 533
{
  ...
  if (LeyLine_M$waitingJoinReq[sim_node()]) {


      LeyLine_M$waitingJoinReq[sim_node()] = FALSE;
      LeyLine_M$dest[sim_node()] = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);

      if (LeyLine_M$SINMode[sim_node()]) {
          LeyLine_M$amIntersection[sim_node()] = TRUE;
          LeyLine_M$starterNode[sim_node()] = FALSE;
          LeyLine_M$SINMode[sim_node()] = FALSE;
        }
      if (LeyLine_M$amIntersection[sim_node()]) {
          if (!LeyLine_M$starterNode[sim_node()]) {
              LeyLine_M$starterNode[sim_node()] = TRUE;
              LeyLine_M$routingTable[sim_node()].intersectionSucc = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
              LeyLine_M$leftDone[sim_node()] = FALSE;
              LeyLine_M$rightDone[sim_node()] = FALSE;
            }
          else 
#line 558
            {
              LeyLine_M$routingTable[sim_node()].intersectionPred = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
            }
        }
      else 
        ...
        {
          if (LeyLine_M$leftDone[sim_node()]) {
              LeyLine_M$routingTable[sim_node()].predecessor = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
            }
          else 
#line 570
            {
              LeyLine_M$routingTable[sim_node()].successor = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
            }
        }
      LeyLine_M$dest[sim_node()] = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
      LeyLine_M$sendLeyLineBuildMsg(__nesc_ntoh_uint16(pktRecv->nodeid.nxdata));
      LeyLine_M$waitingforAck[sim_node()] = TRUE;
    }
  return msg;
}

# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(msg, dest);
  /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(msg, 24);
  return /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$IncorpReqSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 812 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$sendIncorpReq(am_addr_t destination, am_addr_t predecessor, am_addr_t successor)
#line 812
{

  IncorpReq *pktToSend = (IncorpReq *)LeyLine_M$Packet$getPayload(&LeyLine_M$incorpreq[sim_node()], sizeof(IncorpReq ));

#line 815
  __nesc_hton_uint16(pktToSend->nodeid.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(pktToSend->predecessor.nxdata, predecessor);
  __nesc_hton_uint16(pktToSend->successor.nxdata, successor);
  if (LeyLine_M$IncorpReqSend$send(LeyLine_M$latestRTFrom[sim_node()], &LeyLine_M$incorpreq[sim_node()], sizeof(IncorpReq )) == SUCCESS) {
      sim_log_debug(176U, "Leyline", "Incorp Req Sent...\n");
    }
}
...
#line 788
  if (!(LeyLine_M$onCore[sim_node()] || LeyLine_M$onIntersection[sim_node()])) {
      ...
      if (LeyLine_M$latestRTFrom[sim_node()]) {
          if (__nesc_ntoh_uint16(pktRecv->successor.nxdata) == LeyLine_M$latestRTFrom[sim_node()]) {


              LeyLine_M$latestRTFrom[sim_node()] = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
              LeyLine_M$sendIncorpReq(__nesc_ntoh_uint16(pktRecv->nodeid.nxdata), __nesc_ntoh_uint16(pktRecv->nodeid.nxdata), LeyLine_M$latestRTFrom[sim_node()]);
            }
        }
    }
...
#line 836
  if (__nesc_ntoh_uint16(pktRecv->predecessor.nxdata) == TOS_NODE_ID && __nesc_ntoh_uint16(pktRecv->successor.nxdata) == LeyLine_M$routingTable[sim_node()].successor) {

      LeyLine_M$nodeCount[sim_node()] = LeyLine_M$nodeCount[sim_node()] + 1;

      LeyLine_M$dest[sim_node()] = LeyLine_M$routingTable[sim_node()].successor;
      LeyLine_M$routingTable[sim_node()].successor = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
      LeyLine_M$dest[sim_node()] = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
      LeyLine_M$sendIncorpAckMsg(__nesc_ntoh_uint16(pktRecv->nodeid.nxdata));
    }
  else {
    if (__nesc_ntoh_uint16(pktRecv->successor.nxdata) == TOS_NODE_ID && __nesc_ntoh_uint16(pktRecv->predecessor.nxdata) == LeyLine_M$routingTable[sim_node()].predecessor) {


        LeyLine_M$dest[sim_node()] = LeyLine_M$routingTable[sim_node()].predecessor;
        LeyLine_M$routingTable[sim_node()].predecessor = __nesc_ntoh_uint16(pktRecv->nodeid.nxdata);
...
#line 652
{
  ...
  if (!(LeyLine_M$onCore[sim_node()] || LeyLine_M$onIntersection[sim_node()])) {
      ...
      LeyLine_M$nodeCount[sim_node()] = __nesc_ntoh_uint16(btrpkt->nodeCount.nxdata) + 1;
      if (__nesc_ntoh_uint16(btrpkt->predecessor.nxdata) != 0) {
          LeyLine_M$routingTable[sim_node()].predecessor = __nesc_ntoh_uint16(btrpkt->predecessor.nxdata);
          LeyLine_M$sendLeyLineAck(LeyLine_M$routingTable[sim_node()].predecessor);
        }
      else 
#line 665
        {
          LeyLine_M$leftDone[sim_node()] = TRUE;
          LeyLine_M$routingTable[sim_node()].successor = __nesc_ntoh_uint16(btrpkt->successor.nxdata);
          LeyLine_M$sendLeyLineAck(LeyLine_M$routingTable[sim_node()].successor);
        }
      if (__nesc_ntoh_uint16(btrpkt->onCore.nxdata) == 1) {
          LeyLine_M$onCore[sim_node()] = TRUE;
        }
      else 
#line 672
        {
          LeyLine_M$onIntersection[sim_node()] = TRUE;
        }


      LeyLine_M$sendHelloMsg();
    }
  else 
#line 678
    {
...
#line 889
{
  ...
  LeyLine_M$waitingforAck[sim_node()] = FALSE;
...
# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine_M$BackPropTimer$startOneShot(uint32_t dt){
#line 73
...
#line 73
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMPacket$setDestination(msg, dest);
  /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMPacket$setType(msg, 16);
  return /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$IncorpNodeSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 994 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$incorporateNode(uint16_t node)
#line 994
{

  if (!LeyLine_M$busy[sim_node()]) {
      IncorporateNodeMsg *btrpkt = (IncorporateNodeMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$incorpNode[sim_node()], sizeof(IncorporateNodeMsg ));

#line 998
      __nesc_hton_uint16(btrpkt->predecessor.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->successor.nxdata, LeyLine_M$routingTable[sim_node()].successor);
      LeyLine_M$dest[sim_node()] = node;
      if (LeyLine_M$IncorpNodeSend$send(LeyLine_M$dest[sim_node()], &LeyLine_M$incorpNode[sim_node()], sizeof(IncorporateNodeMsg )) == SUCCESS) {
          LeyLine_M$busy[sim_node()] = TRUE;
          sim_log_debug(181U, "Leyline", "IncorporateNodeMsg sent ..... \n");
        }
    }
}
...
#line 1109
{
  ...
  LeyLine_M$nodeCount[sim_node()] = __nesc_ntoh_uint16(btrpkt->nodeCount.nxdata);


  LeyLine_M$backPropMsg[sim_node()] = *msg;




  if (node) {
      LeyLine_M$incorporateNode(node);
    }
  else 
#line 1127
    {

      if (!LeyLine_M$starterNode[sim_node()] && !LeyLine_M$amIntersection[sim_node()]) {


          LeyLine_M$sendRTBroadcast();
          LeyLine_M$BackPropTimer$startOneShot(TIMER_PERIOD_MILLI);
        }
      else {
          ...
          if (LeyLine_M$leftDone[sim_node()] && !LeyLine_M$rightDone[sim_node()]) {


              LeyLine_M$rightDone[sim_node()] = TRUE;
              LeyLine_M$sendAuthSINMsg();
            }
          else {
            if (!LeyLine_M$leftDone[sim_node()] && !LeyLine_M$rightDone[sim_node()]) {
...
#line 1172
  if (__nesc_ntoh_uint16(btrpkt->predecessor.nxdata) != 0) {
      LeyLine_M$routingTable[sim_node()].predecessor = __nesc_ntoh_uint16(btrpkt->predecessor.nxdata);
      LeyLine_M$sendBackPropogation(LeyLine_M$routingTable[sim_node()].predecessor);
    }
  else 
    {
      LeyLine_M$routingTable[sim_node()].successor = __nesc_ntoh_uint16(btrpkt->successor.nxdata);
      LeyLine_M$sendBackPropogation(LeyLine_M$routingTable[sim_node()].successor);
    }
...
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$AuthSINSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 1257 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline message_t *LeyLine_M$AuthSINReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 1257
{
  ...
  if (!LeyLine_M$amCoreLeaf[sim_node()]) {
      if (LeyLine_M$AuthSINSend$send(LeyLine_M$routingTable[sim_node()].successor, msg, sizeof(AuthSINMsg )) == SUCCESS) {


          sim_log_debug(183U, "Leyline", "AuthSINMsg forwarded to %u ..... \n", LeyLine_M$routingTable[sim_node()].successor);
        }
    }
  else {
      ...
      LeyLine_M$sendSINPacket(LeyLine_M$routingTable[sim_node()].predecessor);
    }
...
#line 1286
  LeyLine_M$SINMode[sim_node()] = TRUE;
  LeyLine_M$nodeCount[sim_node()] = __nesc_ntoh_uint16(btrpkt->nodeCount.nxdata);
  ...
  LeyLine_M$myNode[sim_node()] = LeyLine_M$routingTable[sim_node()].predecessor;
...
#line 1328
            {
              LeyLine_M$skipBy[sim_node()] = LeyLine_M$addressSpace[sim_node()] / LeyLine_M$nodeCount[sim_node()];
              LeyLine_M$myAddress[sim_node()] = LeyLine_M$myAddress[sim_node()] + LeyLine_M$skipBy[sim_node()];
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].successorAddr.nxdata, LeyLine_M$myAddress[sim_node()] + LeyLine_M$skipBy[sim_node()]);
              LeyLine_M$sendAssignAddressMsg(LeyLine_M$routingTable[sim_node()].successor);
            }
        }
      else 
...
# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine_M$AppTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(4U, dt);
#line 73
}
#line 73
# 1359 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline message_t *LeyLine_M$AssignAddressMsgReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 1359
{
  ...
  LeyLine_M$skipBy[sim_node()] = __nesc_ntoh_uint8(btrpkt->skipBy.nxdata);
  LeyLine_M$myAddress[sim_node()] = __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata) + __nesc_ntoh_uint8(btrpkt->skipBy.nxdata);

  if (LeyLine_M$amIntersection[sim_node()]) {
      LeyLine_M$myAddress[sim_node()] = __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata);
      LeyLine_M$leftDone[sim_node()] = FALSE;
      LeyLine_M$rightDone[sim_node()] = FALSE;
      if (__nesc_ntoh_uint16(btrpkt->src.nxdata) != LeyLine_M$routingTable[sim_node()].predecessor) {
          LeyLine_M$SINnext[sim_node()] = LeyLine_M$routingTable[sim_node()].predecessor;
        }
      else 
#line 1372
        {
          LeyLine_M$SINnext[sim_node()] = LeyLine_M$routingTable[sim_node()].successor;
        }


      __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata, __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata));
      __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].intersectionSuccAddr.nxdata, LeyLine_M$myAddress[sim_node()] + __nesc_ntoh_uint8(btrpkt->skipBy.nxdata));
      LeyLine_M$sendAssignAddressMsg(LeyLine_M$routingTable[sim_node()].intersectionSucc);
    }
  else {
      if (!LeyLine_M$amCoreLeaf[sim_node()]) {
          if (__nesc_ntoh_uint16(btrpkt->src.nxdata) != LeyLine_M$routingTable[sim_node()].predecessor) {
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].successorAddr.nxdata, __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata));
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata, LeyLine_M$myAddress[sim_node()] + __nesc_ntoh_uint8(btrpkt->skipBy.nxdata));
              LeyLine_M$sendAssignAddressMsg(LeyLine_M$routingTable[sim_node()].predecessor);
            }
          else 
#line 1387
            {
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata, __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata));
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].successorAddr.nxdata, LeyLine_M$myAddress[sim_node()] + __nesc_ntoh_uint8(btrpkt->skipBy.nxdata));
              LeyLine_M$sendAssignAddressMsg(LeyLine_M$routingTable[sim_node()].successor);
            }
        }
      else 
#line 1392
        {
          if (LeyLine_M$onIntersection[sim_node()]) {
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata, __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata));
              LeyLine_M$sendIntAssignAddressComplete(LeyLine_M$myAddress[sim_node()], 0);
            }
          else {

              LeyLine_M$AppTimer$startOneShot(500);
              __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata, __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata));
              LeyLine_M$sendAddrBroadcast();
            }
        }
    }
...
#line 1412
{
  ...
  if (LeyLine_M$amIntersection[sim_node()]) {
      LeyLine_M$tempAddr[sim_node()] = LeyLine_M$myAddress[sim_node()];
      LeyLine_M$myAddress[sim_node()] = __nesc_ntoh_uint8(btrpkt->previousAddr.nxdata);
      ...
      if (LeyLine_M$leftDone[sim_node()] && !LeyLine_M$rightDone[sim_node()]) {
          ...
          LeyLine_M$myAddress[sim_node()] = LeyLine_M$myAddress[sim_node()] + LeyLine_M$skipBy[sim_node()];
          __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].successorAddr.nxdata, LeyLine_M$myAddress[sim_node()] + LeyLine_M$skipBy[sim_node()]);
          LeyLine_M$sendAssignAddressMsg(LeyLine_M$SINnext[sim_node()]);
        }
      else {
        if (!LeyLine_M$leftDone[sim_node()] && !LeyLine_M$rightDone[sim_node()]) {
            ...
            if (LeyLine_M$routingTable[sim_node()].intersectionPred != 0) {
                __nesc_hton_uint16(LeyLine_M$routingTable[sim_node()].intersectionPredAddr.nxdata, LeyLine_M$myAddress[sim_node()] + LeyLine_M$skipBy[sim_node()]);
                LeyLine_M$sendAssignAddressMsg(LeyLine_M$routingTable[sim_node()].intersectionPred);
              }
            else 
#line 1434
              {
      ...
      LeyLine_M$sendIntAssignAddressComplete(__nesc_ntoh_uint8(btrpkt->previousAddr.nxdata), __nesc_ntoh_uint16(btrpkt->src.nxdata));
    }
...
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$SubSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMSend$send(addr, msg, len);
#line 80
...
# 347 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline message_t *LeyLine_M$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 347
{
  return msg;
...
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * LeyLine_M$Receive$receive(am_id_t arg_0x7f3ebed10158, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f3ebed10158) {
#line 78
    case 1:
#line 78
      __nesc_result = LeyLine25nodeTestM$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = LeyLine_M$Receive$default$receive(arg_0x7f3ebed10158, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 1502 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$printRouteTable(void )
#line 1502
{
}
...
#line 358
{
  ...
  leyline_msg_hdr *leyline_hdr2 = (leyline_msg_hdr *)LeyLine_M$Packet$getPayload(&LeyLine_M$p_leyline_msg_[sim_node()], sizeof(leyline_msg_hdr ));

  __nesc_hton_uint16(leyline_hdr2->src.nxdata, __nesc_ntoh_uint16(leyline_hdr->src.nxdata));
  __nesc_hton_uint16(leyline_hdr2->dest.nxdata, __nesc_ntoh_uint16(leyline_hdr->dest.nxdata));




  LeyLine_M$printRouteTable();
  if (__nesc_ntoh_uint16(leyline_hdr->dest.nxdata) == LeyLine_M$myAddress[sim_node()]) {
      sim_log_debug(168U, "msgCount", "%s\t LeyLine: SubReceive.receive() deliver to upper layer:%u\n", sim_time_string(), LeyLine_M$myAddress[sim_node()]);





      p_msg = LeyLine_M$Receive$receive(1, p_msg, payload, 
      len);
    }
  else 
#line 380
    {
      am_addr_t nexthop = LeyLine_M$get_next_hop(__nesc_ntoh_uint16(leyline_hdr->dest.nxdata));

#line 382
      sim_log_debug(169U, "msgCount", "%s\t LeyLine: SubReceive.receive() deliver to next hop:%x\n", sim_time_string(), nexthop);
      ...
      if (LeyLine_M$SubSend$send(nexthop, &LeyLine_M$p_leyline_msg_[sim_node()], sizeof(leyline_msg_hdr )) == SUCCESS) {
          sim_log_debug(170U, "APPS", "%s\t Delivered to next hop:%x\n", sim_time_string(), nexthop);
        }
    }
...
#line 714
  __nesc_hton_uint16(LeyLine_M$shortcutTable[sim_node()][LeyLine_M$neighborCount[sim_node()]].mac.nxdata, mac);
  __nesc_hton_uint16(LeyLine_M$shortcutTable[sim_node()][LeyLine_M$neighborCount[sim_node()]].addr.nxdata, address);
}
...
#line 722
  if (((mac == LeyLine_M$routingTable[sim_node()].predecessor || mac == LeyLine_M$routingTable[sim_node()].successor) || mac == LeyLine_M$routingTable[sim_node()].intersectionPred) || mac == LeyLine_M$routingTable[sim_node()].intersectionSucc) {
      thisNeighbor = mac;
      return thisNeighbor;
    }

  for (i = 0; i < LeyLine_M$counter[sim_node()]; i++) {
      if (__nesc_ntoh_uint16(LeyLine_M$shortcutTable[sim_node()][i].mac.nxdata) == mac) {
          thisNeighbor = __nesc_ntoh_uint16(LeyLine_M$shortcutTable[sim_node()][i].mac.nxdata);
          break;
        }
    }
  return thisNeighbor;
...
#line 1562
  if (LeyLine_M$neighborCount[sim_node()] < MAX_NEIGHBOR_ENTRIES) {
      shortcut = LeyLine_M$getNeighbor(__nesc_ntoh_uint16(btrpkt->mac.nxdata));
      if (shortcut == 0) {

          LeyLine_M$markShortcut(__nesc_ntoh_uint16(btrpkt->mac.nxdata), __nesc_ntoh_uint16(btrpkt->address.nxdata));
          LeyLine_M$neighborCount[sim_node()] = LeyLine_M$neighborCount[sim_node()] + 1;
        }
    }
  if (!LeyLine_M$addressBroadcasted[sim_node()]) {
      LeyLine_M$sendAddrBroadcast();
    }
...
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7f3ebef59340, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f3ebef59340) {
#line 78
    case 10:
#line 78
      __nesc_result = LeyLine_M$HelloReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 11:
#line 78
      __nesc_result = LeyLine_M$JoinReqReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 12:
#line 78
      __nesc_result = LeyLine_M$LeyLineBuildReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 13:
#line 78
      __nesc_result = LeyLine_M$RTBroadcastReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 14:
#line 78
      __nesc_result = LeyLine_M$BackPropagationReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 15:
#line 78
      __nesc_result = LeyLine_M$ChangeSuccessorReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 16:
#line 78
      __nesc_result = LeyLine_M$IncorpNodeReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 17:
#line 78
      __nesc_result = LeyLine_M$IncorpAckReceive$receive(msg, payload, len);
#line 78
      __nesc_result = LeyLine_M$IncorpAckReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 18:
#line 78
      __nesc_result = LeyLine_M$AuthSINReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 19:
#line 78
      __nesc_result = LeyLine_M$SINReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 20:
#line 78
      __nesc_result = LeyLine_M$IntLineBuiltMsgReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 21:
#line 78
      __nesc_result = LeyLine_M$AssignAddressMsgReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 22:
#line 78
      __nesc_result = LeyLine_M$IntAssignAddressCompleteReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 23:
#line 78
      __nesc_result = LeyLine_M$LeyLineAckReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 24:
#line 78
      __nesc_result = LeyLine_M$IncorpReqReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 25:
#line 78
      __nesc_result = LeyLine_M$SubReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 26:
#line 78
      __nesc_result = LeyLine_M$AddrBroadcastReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7f3ebef59340, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 78
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75

#line 75
  __nesc_result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(16U, msg, len);
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMPacket$setDestination(msg, dest);
  /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMPacket$setType(msg, 26);
  return /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$AddrBroadcastSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMSend$send(addr, msg, len);
#line 80
...
#line 78
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7f3ebe837650, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7f3ebe837650, addr, msg, len);
#line 80
...
#line 80
#line 110
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7f3ebef5a220, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7f3ebef5a220, msg, error);
#line 110
}
#line 110
...
#line 67
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] + 1) % 17;
  for (i = 0; i < 17; i++) {
  ...
  if (i >= 17) {
#line 78
    /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 17;
    }
}
...
# 1104 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$AddrBroadcastSend$sendDone(message_t *msg, error_t error)
#line 1104
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$AddrBroadcastSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$AMSend$sendDone(m, err);
}

# 135 "LeyLine25nodeTestM.nc"
static inline void LeyLine25nodeTestM$AMSend$sendDone(message_t *bufPtr, error_t error)
#line 135
{
}

# 331 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 331
{
  return;
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void LeyLine_M$AMSend$sendDone(am_id_t arg_0x7f3ebed11020, message_t * msg, error_t error){
#line 110
  switch (arg_0x7f3ebed11020) {
#line 110
    case 1:
#line 110
      LeyLine25nodeTestM$AMSend$sendDone(msg, error);
#line 110
      break;
#line 110
    default:
#line 110
      LeyLine_M$AMSend$default$sendDone(arg_0x7f3ebed11020, msg, error);
#line 110
      break;
#line 110
    }
...
#line 110
# 351 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$SubSend$sendDone(message_t *msg, error_t error)
#line 351
{

  LeyLine_M$AMSend$sendDone(1, msg, error);
}

# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$SubSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMSend$sendDone(m, err);
}

# 1099 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$IntAssignAddressCompleteSend$sendDone(message_t *msg, error_t error)
#line 1099
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$IntAssignAddressCompleteSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMSend$sendDone(m, err);
}

# 1093 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$AssignAddressMsgSend$sendDone(message_t *msg, error_t error)
#line 1093
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$AssignAddressMsgSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMSend$sendDone(m, err);
}

# 1089 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$IntLineBuiltMsgSend$sendDone(message_t *msg, error_t error)
#line 1089
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$IntLineBuiltMsgSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMSend$sendDone(m, err);
}

# 1085 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$SINSend$sendDone(message_t *msg, error_t error)
#line 1085
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$SINSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMSend$sendDone(m, err);
}

# 1081 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$AuthSINSend$sendDone(message_t *msg, error_t error)
#line 1081
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$AuthSINSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMSend$sendDone(m, err);
}

# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$IncorpAckSend$sendDone(msg, error);
#line 110
  LeyLine_M$IncorpAckSend$sendDone(msg, error);
#line 110
}
...
#line 65
{
  /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$sendDone(m, err);
}

# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMPacket$setDestination(msg, dest);
  /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMPacket$setType(msg, 15);
  return /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$ChangeSuccessorSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 1010 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$sendChangeSuccessorMsg(uint16_t node)
#line 1010
{


  ChangeSuccessorMsg *btrpkt = (ChangeSuccessorMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$changeSucc[sim_node()], sizeof(ChangeSuccessorMsg ));

#line 1014
  if (node == LeyLine_M$routingTable[sim_node()].predecessor) {
      __nesc_hton_uint16(btrpkt->successor.nxdata, node);
      __nesc_hton_uint16(btrpkt->predecessor.nxdata, 0);
    }
  else 
#line 1017
    {
      __nesc_hton_uint16(btrpkt->successor.nxdata, 0);
      __nesc_hton_uint16(btrpkt->predecessor.nxdata, node);
    }
  __nesc_hton_uint16(btrpkt->nodeCount.nxdata, LeyLine_M$nodeCount[sim_node()]);



  if (LeyLine_M$ChangeSuccessorSend$send(LeyLine_M$dest[sim_node()], &LeyLine_M$changeSucc[sim_node()], sizeof(ChangeSuccessorMsg )) == SUCCESS) {

      sim_log_debug(182U, "Leyline", "Change Successor Msg sent to %u ..... \n", LeyLine_M$routingTable[sim_node()].successor);
    }
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$IncorpNodeSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$AMSend$sendDone(m, err);
}

# 1067 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$ChangeSuccessorSend$sendDone(message_t *msg, error_t error)
#line 1067
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$ChangeSuccessorSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$AMSend$sendDone(m, err);
}

# 1063 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$BackPropagationSend$sendDone(message_t *msg, error_t error)
#line 1063
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$BackPropagationSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMSend$sendDone(m, err);
}

# 1059 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$LeyLineAckSend$sendDone(message_t *msg, error_t error)
#line 1059
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$LeyLineAckSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMSend$sendDone(m, err);
}
...
# 64 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine_M$LeyLineAckTimer$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(3U, dt);
#line 64
}
#line 64
# 1049 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$LeyLineBuildSend$sendDone(message_t *msg, error_t error)
#line 1049
{
  ...
  if (error == SUCCESS) {
      ...
      LeyLine_M$LeyLineAckTimer$startPeriodic(TIMER_PERIOD_MILLI);
    }
}

# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$LeyLineBuildSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$sendDone(m, err);
}
...
#line 53
  union __nesc_unnamed4316 __nesc_result;
#line 53
...
#line 53
# 825 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$IncorpReqSend$sendDone(message_t *msg, error_t error)
#line 825
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$IncorpReqSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(m, err);
}

# 1034 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$RTBroadcastSend$sendDone(message_t *msg, error_t error)
#line 1034
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$RTBroadcastSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(m, err);
}

# 485 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$JoinReqSend$sendDone(message_t *msg, error_t error)
#line 485
{
}
...
# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$JoinReqSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}

# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine_M$HelloMsgTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(0U, dt);
#line 73
}
#line 73
# 446 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$HelloSend$sendDone(message_t *msg, error_t error)
#line 446
{

  LeyLine_M$HelloMsgTimer$startOneShot(TIMER_PERIOD_MILLI);
}

# 110 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  LeyLine_M$HelloSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
#line 162
inline static void /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75

#line 75
  __nesc_result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(15U, msg, len);
#line 75
...
#line 75
inline static error_t /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75

#line 75
  __nesc_result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(13U, msg, len);
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMPacket$setDestination(msg, dest);
  /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMPacket$setType(msg, 21);
  return /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$AssignAddressMsgSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75

#line 75
  __nesc_result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(14U, msg, len);
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMPacket$setDestination(msg, dest);
  /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMPacket$setType(msg, 22);
  return /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$IntAssignAddressCompleteSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMPacket$setDestination(msg, dest);
  /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMPacket$setType(msg, 19);
  return /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$SINSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75

#line 75
  __nesc_result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(12U, msg, len);
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMPacket$setDestination(msg, dest);
  /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMPacket$setType(msg, 20);
  return /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$IntLineBuiltMsgSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$HelloSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
#line 162
inline static void /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
inline static error_t /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMPacket$setDestination(msg, dest);
  /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMPacket$setType(msg, 14);
  return /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$BackPropagationSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(msg, dest);
  /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(msg, 13);
  return /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$RTBroadcastSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75

#line 75
  __nesc_result = /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$send(5U, msg, len);
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMPacket$setDestination(msg, dest);
  /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMPacket$setType(msg, 23);
  return /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$LeyLineAckSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$AMSend$send(addr, msg, len);
#line 80
...
# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$IncorpAckSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$send(addr, msg, len);
#line 80
  __nesc_result = ecombine(__nesc_result, /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMSend$send(addr, msg, len));
#line 80
...
#line 80
# 103 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
#line 162
inline static void /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
inline static error_t /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setDestination(msg, dest);
  /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setType(msg, 12);
  return /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$send(msg, len);
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine_M$LeyLineBuildSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$send(addr, msg, len);
#line 80
...
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7f3ebef57020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7f3ebef57020, msg, payload, len);
#line 78
...
# 104 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static error_t LeyLine_M$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 73 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine_M$LeyLineBuildTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(1U, dt);
#line 73
}
#line 73
# 415 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$AMControl$startDone(error_t err)
#line 415
{
  ...
  if (err == SUCCESS) {
      ...
      LeyLine_M$LeyLineBuildTimer$startOneShot(TIMER_PERIOD_MILLI);
    }
  else {
      LeyLine_M$AMControl$start();
    }
}
...
#line 113
  LeyLine_M$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/tossim/TossimPacketModelC.nc"
...
# 1043 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$AMControl$stopDone(error_t err)
#line 1043
{
}
...
#line 138
  LeyLine_M$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 75 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7f3ebf24e108){
#line 75
  switch (arg_0x7f3ebf24e108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7f3ebf24e108);
#line 75
      break;
#line 75
    }
...
#line 75
# 490 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$HelloMsgTimer$fired(void )
#line 490
{
  if (LeyLine_M$waitingJoinReq[sim_node()]) {
      ...
      if (LeyLine_M$SINMode[sim_node()]) {
          if (!LeyLine_M$amIntersection[sim_node()]) {
            LeyLine_M$sendSINPacket(LeyLine_M$myNode[sim_node()]);
            }
          else 
#line 498
            {
              LeyLine_M$sendSINPacket(LeyLine_M$routingTable[sim_node()].intersectionPred);
            }
        }
      else 
#line 501
        {
          LeyLine_M$amCoreLeaf[sim_node()] = TRUE;
          if (LeyLine_M$leftDone[sim_node()] && LeyLine_M$starterNode[sim_node()]) {
              LeyLine_M$rightDone[sim_node()] = TRUE;
              LeyLine_M$sendAuthSINMsg();
            }
          else 
...
# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine_M$LeyLineAckTimer$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(3U);
#line 78
}
#line 78
# 629 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$LeyLineAckTimer$fired(void )
#line 629
{
  if (LeyLine_M$waitingforAck[sim_node()]) {
      LeyLine_M$sendLeyLineBuildMsg(LeyLine_M$dest[sim_node()]);
    }
  else 
#line 632
    {
      LeyLine_M$LeyLineAckTimer$stop();
    }
}
...
#line 67
# 115 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/tossim/TossimPacketModelC.nc"
static inline error_t TossimPacketModelC$Control$stop(void )
#line 115
{
  if (!TossimPacketModelC$initialized[sim_node()]) {
...
# 130 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static error_t LeyLine_M$AMControl$stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130
...
#line 130
# 167 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline error_t LeyLine_M$SplitControl$stop(void )
#line 167
{

  LeyLine_M$AMControl$stop();
  return SUCCESS;
}

# 130 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static error_t LeyLine25nodeTestM$SplitControl$stop(void ){
#line 130
  unsigned char __nesc_result;
#line 130

#line 130
  __nesc_result = LeyLine_M$SplitControl$stop();
#line 130
...
#line 130
# 64 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine25nodeTestM$FirstTimer$startPeriodic(uint32_t dt){
#line 64
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startPeriodic(5U, dt);
#line 64
}
#line 64
# 46 "LeyLine25nodeTestM.nc"
static inline void LeyLine25nodeTestM$SplitControl$startDone(error_t err)
#line 46
{
  ...
  sim_log_debug(148U, "APPS", "%s\t APPS: startDone %d.\n", sim_time_string(), err);
  LeyLine25nodeTestM$p_pkt[sim_node()] = &LeyLine25nodeTestM$pkt[sim_node()];



  sim_log_debug(149U, "APPS", "%s\t APPS: startDone %d.\n", sim_time_string(), err);
  LeyLine25nodeTestM$src[sim_node()] = TOS_NODE_ID;
  if (TOS_NODE_ID == LeyLine25nodeTestM$src[sim_node()]) {

      sim_log_debug(150U, "msgCount", "%u\n", LeyLine25nodeTestM$src[sim_node()]);
      LeyLine25nodeTestM$FirstTimer$startPeriodic(1000);
    }
  else 
#line 61
    {
      LeyLine25nodeTestM$SplitControl$stop();
    }
}

# 113 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static void LeyLine_M$SplitControl$startDone(error_t error){
#line 113
  LeyLine25nodeTestM$SplitControl$startDone(error);
#line 113
}
#line 113
# 1517 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline void LeyLine_M$printShortcutTable(void )
#line 1517
{
...
#line 1520
  for (i = 0; i < LeyLine_M$neighborCount[sim_node()]; i++) {
    }
}
...
#line 1577
{
  LeyLine_M$printShortcutTable();
  if (LeyLine_M$amCoreLeaf[sim_node()] && !LeyLine_M$onIntersection[sim_node()]) {
      LeyLine_M$SplitControl$startDone(SUCCESS);
    }
}

# 78 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void LeyLine25nodeTestM$FirstTimer$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(5U);
#line 78
}
#line 78
# 257 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline error_t LeyLine_M$AMSend$send(am_id_t id, am_addr_t addr, message_t *msg, uint8_t len)
#line 257
{
  ...
  leyline_msg_hdr *leyline_hdr = (leyline_msg_hdr *)LeyLine_M$Packet$getPayload(&LeyLine_M$p_leyline_msg_[sim_node()], sizeof(leyline_msg_hdr ));
  am_addr_t nexthop = 0;

#line 265
  LeyLine_M$amSrc[sim_node()] = TRUE;

  LeyLine_M$printRouteTable();

  if (addr == LeyLine_M$myAddress[sim_node()]) {
      return SUCCESS;
    }
  else 
#line 271
    {
      nexthop = LeyLine_M$get_next_hop(addr);
    }




  __nesc_hton_uint16(leyline_hdr->dest.nxdata, addr);
  __nesc_hton_uint16(leyline_hdr->src.nxdata, LeyLine_M$myAddress[sim_node()]);


  sim_log_debug(165U, "APPS", "Next Hop:%u...\n", nexthop);
#line 294
  sim_log_debug(166U, "APPS", "%s\t AODV: AMSend.send() dest: %d id: %d len: %d nexthop: %d\n", sim_time_string(), addr, id, len, nexthop);


  if (LeyLine_M$SubSend$send(nexthop, &LeyLine_M$p_leyline_msg_[sim_node()], sizeof(leyline_msg_hdr )) == SUCCESS) {

      sim_log_debug(167U, "APPS", "Here2...\n");
      LeyLine_M$amSrc[sim_node()] = FALSE;
      return SUCCESS;
    }
}

# 80 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t LeyLine25nodeTestM$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = LeyLine_M$AMSend$send(1, addr, msg, len);
#line 80
...
#line 80
# 77 "LeyLine25nodeTestM.nc"
static inline void LeyLine25nodeTestM$FirstTimer$fired(void )
#line 77
{
  sim_log_debug(151U, "APPS", "Timer fired...\n");
  sim_log_debug(152U, "APPS", "dest:%u,skipBy:%u,myAddress:%u...\n", LeyLine25nodeTestM$dest[sim_node()], LeyLine25nodeTestM$skipby[sim_node()], LeyLine25nodeTestM$myAddress[sim_node()]);
  if (LeyLine25nodeTestM$dest[sim_node()] + LeyLine25nodeTestM$skipby[sim_node()] < LeyLine25nodeTestM$myAddress[sim_node()]) {
      LeyLine25nodeTestM$dest[sim_node()] = LeyLine25nodeTestM$dest[sim_node()] + LeyLine25nodeTestM$skipby[sim_node()];
      if (LeyLine25nodeTestM$dest[sim_node()] == LeyLine25nodeTestM$myAddress[sim_node()]) {
          LeyLine25nodeTestM$dest[sim_node()] = LeyLine25nodeTestM$dest[sim_node()] + LeyLine25nodeTestM$skipby[sim_node()];
        }
      sim_log_debug(153U, "APPS", "Dest is now....%u\n", LeyLine25nodeTestM$dest[sim_node()]);
      LeyLine25nodeTestM$AMSend$send(LeyLine25nodeTestM$dest[sim_node()], LeyLine25nodeTestM$p_pkt[sim_node()], 5);
      sim_log_debug(154U, "APPS", "AMSend called....%u\n", LeyLine25nodeTestM$dest[sim_node()]);
    }
  else 
#line 88
    {
      if (LeyLine25nodeTestM$noTimes[sim_node()] < LeyLine25nodeTestM$maxTimes[sim_node()]) {
          LeyLine25nodeTestM$dest[sim_node()] = 0;
          LeyLine25nodeTestM$noTimes[sim_node()] = LeyLine25nodeTestM$noTimes[sim_node()] + 1;
        }
      else 
#line 92
        {
          LeyLine25nodeTestM$FirstTimer$stop();
        }
    }
}
...
# 83 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7f3ebe8d0da0){
#line 83
  switch (arg_0x7f3ebe8d0da0) {
#line 83
    case 0U:
#line 83
      LeyLine_M$HelloMsgTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      LeyLine_M$LeyLineBuildTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      LeyLine_M$BackPropTimer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      LeyLine_M$LeyLineAckTimer$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      LeyLine_M$AppTimer$fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      LeyLine25nodeTestM$FirstTimer$fired();
#line 83
      break;
#line 83
    case 6U:
#line 83
      LeyLine25nodeTestM$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7f3ebe8d0da0);
#line 83
      break;
#line 83
    }
...
#line 57
  {
    sim_log_debug(188U, "Init", "LEDS: initialized.\n");
...
#line 62
# 144 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static inline error_t LeyLine_M$SplitControl$start(void )
#line 144
{
...
#line 147
  ...
  for (i = 0; i < MAX_NEIGHBOR_ENTRIES; i++) {
      __nesc_hton_uint16(LeyLine_M$shortcutTable[sim_node()][i].mac.nxdata, 0);
      __nesc_hton_uint16(LeyLine_M$shortcutTable[sim_node()][i].addr.nxdata, 0);
    }

  LeyLine_M$p_app_msg_[sim_node()] = &LeyLine_M$app_msg_[sim_node()];
...
# 104 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static error_t LeyLine25nodeTestM$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104

#line 104
  __nesc_result = LeyLine_M$SplitControl$start();
#line 104
...
#line 104
# 36 "LeyLine25nodeTestM.nc"
static inline void LeyLine25nodeTestM$Boot$booted(void )
#line 36
{
  LeyLine25nodeTestM$SplitControl$start();

  LeyLine25nodeTestM$skipby[sim_node()] = LeyLine25nodeTestM$addressSpace[sim_node()] / LeyLine25nodeTestM$numberNodes[sim_node()];
  LeyLine25nodeTestM$myAddress[sim_node()] = LeyLine25nodeTestM$numberNodes[sim_node()] * LeyLine25nodeTestM$skipby[sim_node()];
}

# 60 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  LeyLine25nodeTestM$Boot$booted();
#line 60
}
#line 60
...
# 1538 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static void LeyLine_M$sendAddrBroadcast(void )
#line 1538
{

  AddrBroadcastMsg *btrpkt = (AddrBroadcastMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$addrBroadcastMsg[sim_node()], sizeof(AddrBroadcastMsg ));

#line 1541
  __nesc_hton_uint16(btrpkt->mac.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(btrpkt->address.nxdata, LeyLine_M$myAddress[sim_node()]);




  if (LeyLine_M$AddrBroadcastSend$send(AM_BROADCAST_ADDR, &LeyLine_M$addrBroadcastMsg[sim_node()], sizeof(AddrBroadcastMsg )) == SUCCESS) {
      sim_log_debug(187U, "Leyline", "Address Broadcast sent ..... \n");
      LeyLine_M$addressBroadcasted[sim_node()] = TRUE;
    }
}
...
#line 91
{
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 17) {
      error_t err;
...
# 100 "/opt/local/src/tinyos-release-tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7f3ebe839460, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f3ebe839460) {
#line 100
    case 0U:
#line 100
      /*LeyLine.HelloSend.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 1U:
#line 100
      /*LeyLine.JoinReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 2U:
#line 100
      /*LeyLine.RTBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 3U:
#line 100
      /*LeyLine.IncorpReqSend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 4U:
#line 100
      /*LeyLine.LeyLineBuildSend.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 5U:
#line 100
      /*LeyLine.LeyLineAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$5$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 6U:
#line 100
      /*LeyLine.BackPropagationSend.SenderC.AMQueueEntryP*/AMQueueEntryP$6$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 7U:
#line 100
      /*LeyLine.ChangeSuccessorSend.SenderC.AMQueueEntryP*/AMQueueEntryP$7$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 8U:
#line 100
      /*LeyLine.IncorpNodeSend.SenderC.AMQueueEntryP*/AMQueueEntryP$8$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 9U:
#line 100
      /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 10U:
#line 100
      /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 11U:
#line 100
      /*LeyLine.SINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$11$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 12U:
#line 100
      /*LeyLine.IntLineBuiltMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$12$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 13U:
#line 100
      /*LeyLine.AssignAddressMsgSend.SenderC.AMQueueEntryP*/AMQueueEntryP$13$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 14U:
#line 100
      /*LeyLine.IntAddressCompleteSend.SenderC.AMQueueEntryP*/AMQueueEntryP$14$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 15U:
#line 100
      /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 16U:
#line 100
      /*LeyLine.AddrBroadcastSend.SenderC.AMQueueEntryP*/AMQueueEntryP$16$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7f3ebe839460, msg, error);
#line 100
      break;
#line 100
    }
...
#line 100
# 1075 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static void LeyLine_M$IncorpAckSend$sendDone(message_t *msg, error_t error)
#line 1075
{

  IncorpAckMsg *btrpkt = (IncorpAckMsg *)LeyLine_M$Packet$getPayload(msg, sizeof(IncorpAckMsg ));

#line 1078
  LeyLine_M$sendChangeSuccessorMsg(__nesc_ntoh_uint16(btrpkt->nodeid.nxdata));
}
...
# 174 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static am_addr_t LeyLine_M$get_next_hop(uint16_t destination)
#line 174
{

  uint16_t i;
  uint16_t pred = __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata);
  uint16_t succ = __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].successorAddr.nxdata);
  int dist = destination - LeyLine_M$myAddress[sim_node()];

#line 180
  sim_log_debug(155U, "APPS", "Predecessor Addr:%u....\n", pred);
  sim_log_debug(156U, "APPS", "Successor Addr:%u....\n", succ);

  for (i = 0; i < MAX_NEIGHBOR_ENTRIES; i++) {
      if (__nesc_ntoh_uint16(LeyLine_M$shortcutTable[sim_node()][i].addr.nxdata) == destination) {
          return __nesc_ntoh_uint16(LeyLine_M$shortcutTable[sim_node()][i].mac.nxdata);
        }
    }
  ...
  if (!LeyLine_M$amIntersection[sim_node()]) {
      ...
      if (LeyLine_M$amCoreLeaf[sim_node()]) {
          if (LeyLine_M$routingTable[sim_node()].successor == 0) {
              return LeyLine_M$routingTable[sim_node()].predecessor;
            }
          else 
#line 207
            {
              return LeyLine_M$routingTable[sim_node()].successor;
            }
        }
      if (dist < 0) {
          if (pred < succ) {
              sim_log_debug(157U, "APPS", "Destination is 3:%u....\n", LeyLine_M$routingTable[sim_node()].predecessor);
              return LeyLine_M$routingTable[sim_node()].predecessor;
            }
          else 
#line 215
            {
              sim_log_debug(158U, "APPS", "Destination is 4:%u....\n", LeyLine_M$routingTable[sim_node()].successor);
              return LeyLine_M$routingTable[sim_node()].successor;
            }
        }
      else 
#line 219
        {
          if (pred > succ) {
              sim_log_debug(159U, "APPS", "Destination is 5:%u....\n", LeyLine_M$routingTable[sim_node()].predecessor);
...
#line 224
            {
              sim_log_debug(160U, "APPS", "Destination is 6:%u....\n", LeyLine_M$routingTable[sim_node()].successor);
              return LeyLine_M$routingTable[sim_node()].successor;
            }
        }
    }
  else {
      if (destination >= __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].successorAddr.nxdata)) {
          sim_log_debug(161U, "APPS", "Destination is 7:%u....\n", LeyLine_M$routingTable[sim_node()].successor);
          return LeyLine_M$routingTable[sim_node()].successor;
        }
      else {
#line 234
        if (destination <= __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].predecessorAddr.nxdata)) {
            sim_log_debug(162U, "APPS", "Destination is 8:%u....\n", LeyLine_M$routingTable[sim_node()].predecessor);
            return LeyLine_M$routingTable[sim_node()].predecessor;
          }
        else {
#line 237
          if (destination < LeyLine_M$myAddress[sim_node()] && destination >= __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].intersectionSuccAddr.nxdata) && (destination < __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].intersectionPredAddr.nxdata) || __nesc_ntoh_uint16(LeyLine_M$routingTable[sim_node()].intersectionPredAddr.nxdata) == 0)) {
              sim_log_debug(163U, "APPS", "Destination is 9:%u....\n", LeyLine_M$routingTable[sim_node()].intersectionSucc);
              return LeyLine_M$routingTable[sim_node()].intersectionSucc;
            }
          else 
#line 240
            {
              sim_log_debug(164U, "APPS", "Destination is 10:%u....\n", LeyLine_M$routingTable[sim_node()].intersectionPred);
              return LeyLine_M$routingTable[sim_node()].intersectionPred;
            }
          }
        }
    }
...
#line 55
{
  /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMPacket$setDestination(msg, dest);
  /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$AMPacket$setType(msg, 25);
  return /*LeyLine.SubSend.SenderC.AMQueueEntryP*/AMQueueEntryP$15$Send$send(msg, len);
}

# 1460 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static void LeyLine_M$sendAssignAddressMsg(am_addr_t node)
#line 1460
{

  AssignAddressMsg *btrpkt = (AssignAddressMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$assignAddrMsg[sim_node()], sizeof(AssignAddressMsg ));

#line 1463
  __nesc_hton_uint8(btrpkt->previousAddr.nxdata, LeyLine_M$myAddress[sim_node()]);
  __nesc_hton_uint8(btrpkt->skipBy.nxdata, LeyLine_M$skipBy[sim_node()]);
  __nesc_hton_uint16(btrpkt->src.nxdata, TOS_NODE_ID);
  if (LeyLine_M$AssignAddressMsgSend$send(node, &LeyLine_M$assignAddrMsg[sim_node()], sizeof(AssignAddressMsg )) == SUCCESS) {
      sim_log_debug(185U, "Leyline", "AssignAddressMsg sent ..... \n");
    }
}
...
#line 1473
{
  ...
  IntAddressCompleteMsg *btrpkt = (IntAddressCompleteMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$assignAddrComp[sim_node()], sizeof(IntAddressCompleteMsg ));

#line 1476
  __nesc_hton_uint8(btrpkt->previousAddr.nxdata, addr);
  __nesc_hton_uint16(btrpkt->src.nxdata, TOS_NODE_ID);

  if (LeyLine_M$routingTable[sim_node()].predecessor == 0 || LeyLine_M$routingTable[sim_node()].successor == 0) {
      if (LeyLine_M$routingTable[sim_node()].predecessor != 0) {
          LeyLine_M$dest[sim_node()] = LeyLine_M$routingTable[sim_node()].predecessor;
        }
      else 
#line 1482
      ...
      if (LeyLine_M$routingTable[sim_node()].predecessor == src) {
          LeyLine_M$dest[sim_node()] = LeyLine_M$routingTable[sim_node()].successor;
        }
      else 
#line 1489
  ...
  if (LeyLine_M$IntAssignAddressCompleteSend$send(LeyLine_M$dest[sim_node()], &LeyLine_M$assignAddrComp[sim_node()], sizeof(IntAddressCompleteMsg )) == SUCCESS) {
      sim_log_debug(186U, "Leyline", "Assign Address Complete sent to %u..... \n", LeyLine_M$dest[sim_node()]);
    }
}
...
#line 897
{
  ...
  SINMsg *btrpkt = (SINMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$SIN[sim_node()], sizeof(SINMsg ));

#line 900
  __nesc_hton_uint16(btrpkt->intersection.nxdata, 1);
  __nesc_hton_uint16(btrpkt->nodeCount.nxdata, LeyLine_M$nodeCount[sim_node()]);
  LeyLine_M$dest[sim_node()] = node;
  if (LeyLine_M$SINSend$send(LeyLine_M$dest[sim_node()], &LeyLine_M$SIN[sim_node()], sizeof(SINMsg )) == SUCCESS) {


      sim_log_debug(178U, "Leyline", "SIN Packet sent to %u ..... \n", node);
    }
}
...
#line 1451
{
  ...
  if (LeyLine_M$IntLineBuiltMsgSend$send(LeyLine_M$routingTable[sim_node()].successor, &LeyLine_M$intLineBuiltMsg[sim_node()], sizeof(IntLineBuiltMsg )) == SUCCESS) {
      sim_log_debug(184U, "Leyline", "IntLineBuiltMsg sent ..... \n");
    }
}
...
#line 434
{
  ...
  LeyLineHelloMsg *btrpkt = (LeyLineHelloMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$hello[sim_node()], sizeof(LeyLineHelloMsg ));

#line 437
  __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);


  if (LeyLine_M$HelloSend$send(AM_BROADCAST_ADDR, &LeyLine_M$hello[sim_node()], sizeof(LeyLineHelloMsg )) == SUCCESS) {
      LeyLine_M$waitingJoinReq[sim_node()] = TRUE;
      sim_log_debug(171U, "Leyline", "Broadcasting Hello Msg...\n");
    }
}
...
#line 55
{
  /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMPacket$setDestination(msg, dest);
  /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$AMPacket$setType(msg, 18);
  return /*LeyLine.AuthSINSend.SenderC.AMQueueEntryP*/AMQueueEntryP$10$Send$send(msg, len);
}

# 1218 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static message_t *LeyLine_M$IncorpAckReceive$receive(message_t *msg, void *payload, uint8_t len)
#line 1218
{
...
#line 911
{
  ...
  BackPropagationMsg *btrpkt = (BackPropagationMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$backPropMsg[sim_node()], sizeof(BackPropagationMsg ));
...
#line 936
  ...
  if (LeyLine_M$BackPropagationSend$send(predecessor, &LeyLine_M$backPropMsg[sim_node()], sizeof(BackPropagationMsg )) == SUCCESS) {
      LeyLine_M$busy[sim_node()] = TRUE;
      sim_log_debug(179U, "Leyline", "Back Propagation Msg sent ..... \n");
    }
}
...
#line 771
{
  ...
  RTBroadcast *pktToSend = (RTBroadcast *)LeyLine_M$Packet$getPayload(&LeyLine_M$rtbroadcast[sim_node()], sizeof(RTBroadcast ));

#line 774
  __nesc_hton_uint16(pktToSend->nodeid.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(pktToSend->predecessor.nxdata, LeyLine_M$routingTable[sim_node()].predecessor);
  __nesc_hton_uint16(pktToSend->successor.nxdata, LeyLine_M$routingTable[sim_node()].successor);


  if (LeyLine_M$RTBroadcastSend$send(AM_BROADCAST_ADDR, &LeyLine_M$rtbroadcast[sim_node()], sizeof(RTBroadcast )) == SUCCESS) {
      sim_log_debug(175U, "Leyline", "Sent RTBroadcast...\n");
    }
}
...
#line 948
{
  ...
  AuthSINMsg *btrpkt = (AuthSINMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$authSIN[sim_node()], sizeof(AuthSINMsg ));

#line 951
  __nesc_hton_uint16(btrpkt->nodeCount.nxdata, LeyLine_M$nodeCount[sim_node()]);
  if (LeyLine_M$amIntersection[sim_node()]) {
      LeyLine_M$dest[sim_node()] = LeyLine_M$routingTable[sim_node()].intersectionSucc;
    }
  else 
#line 954
    {
  ...
  if (LeyLine_M$AuthSINSend$send(LeyLine_M$dest[sim_node()], &LeyLine_M$authSIN[sim_node()], sizeof(AuthSINMsg )) == SUCCESS) {


      sim_log_debug(180U, "Leyline", "AuthSINMsg sent to %u ..... \n", LeyLine_M$dest[sim_node()]);
    }
}
...
#line 638
{
  ...
  LeyLineBuildAck *ackpkt = (LeyLineBuildAck *)LeyLine_M$Packet$getPayload(&LeyLine_M$leylineAck[sim_node()], sizeof(LeyLineBuildAck ));

  __nesc_hton_uint8(ackpkt->participating.nxdata, 1);
  if (LeyLine_M$LeyLineAckSend$send(destination, &LeyLine_M$leylineAck[sim_node()], sizeof(LeyLineBuildAck )) == SUCCESS) {

      sim_log_debug(173U, "Leyline", "ACK sent ..... \n");
    }
}
...
#line 862
{
  ...
  IncorpAckMsg *btrpkt = (IncorpAckMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$incorpACK[sim_node()], sizeof(IncorpAckMsg ));

  __nesc_hton_uint16(btrpkt->nodeid.nxdata, TOS_NODE_ID);
  if (LeyLine_M$routingTable[sim_node()].predecessor == destination) {
      __nesc_hton_uint16(btrpkt->predecessor.nxdata, LeyLine_M$dest[sim_node()]);
      __nesc_hton_uint16(btrpkt->successor.nxdata, TOS_NODE_ID);
    }
  else 
#line 870
    {
      __nesc_hton_uint16(btrpkt->predecessor.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(btrpkt->successor.nxdata, LeyLine_M$dest[sim_node()]);
    }




  if (LeyLine_M$IncorpAckSend$send(destination, &LeyLine_M$incorpACK[sim_node()], sizeof(IncorpAckMsg )) == SUCCESS) {
      sim_log_debug(177U, "Leyline", "Incorp ACK sent to %u ..... \n", destination);
...
#line 55
{
  /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMPacket$setDestination(msg, dest);
  /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$AMPacket$setType(msg, 17);
  return /*LeyLine.IncorpAckSend.SenderC.AMQueueEntryP*/AMQueueEntryP$9$Send$send(msg, len);
}

# 736 "/opt/local/src/tinyos-release-tinyos-2_1_2/apps/LeyLine/lib/LeyLine_M.nc"
static void LeyLine_M$sendLeyLineBuildMsg(am_addr_t destination)
#line 736
{


  LeyLineBuildMsg *btrpkt = (LeyLineBuildMsg *)LeyLine_M$Packet$getPayload(&LeyLine_M$startLine[sim_node()], sizeof(LeyLineBuildMsg ));
...
#line 748
  ...
  if (LeyLine_M$onIntersection[sim_node()] || LeyLine_M$amIntersection[sim_node()]) {
      __nesc_hton_uint16(btrpkt->onCore.nxdata, 0);
    }
  else 
#line 755
    {
      __nesc_hton_uint16(btrpkt->onCore.nxdata, 1);
    }
  ...
  if (LeyLine_M$LeyLineBuildSend$send(destination, &LeyLine_M$startLine[sim_node()], sizeof(LeyLineBuildMsg )) == SUCCESS) {

      sim_log_debug(174U, "Leyline", "LeyLine Build Msg sent to %u..... \n", destination);
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "LeyLine25nodeTestM$pkt"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$pkt[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$p_pkt"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$p_pkt[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$p_pkt[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$src"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$src[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$src[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$dest"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$dest[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$dest[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$numberNodes"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$numberNodes[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$numberNodes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$addressSpace"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$addressSpace[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$addressSpace[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$skipby"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$skipby[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$skipby[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$myAddress"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$myAddress[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$myAddress[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$noTimes"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$noTimes[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$noTimes[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine25nodeTestM$maxTimes"))
  {
    *addr = (uintptr_t)&LeyLine25nodeTestM$maxTimes[__nesc_mote];
    *size = sizeof(LeyLine25nodeTestM$maxTimes[__nesc_mote]);
    return 0;
  }

  /* Module LeyLine_M */
  if (!strcmp(varname, "LeyLine_M$counter"))
  {
    *addr = (uintptr_t)&LeyLine_M$counter[__nesc_mote];
    *size = sizeof(LeyLine_M$counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$nodeCount"))
  {
    *addr = (uintptr_t)&LeyLine_M$nodeCount[__nesc_mote];
    *size = sizeof(LeyLine_M$nodeCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$busy"))
  {
    *addr = (uintptr_t)&LeyLine_M$busy[__nesc_mote];
    *size = sizeof(LeyLine_M$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$starterNode"))
  {
    *addr = (uintptr_t)&LeyLine_M$starterNode[__nesc_mote];
    *size = sizeof(LeyLine_M$starterNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$amIntersection"))
  {
    *addr = (uintptr_t)&LeyLine_M$amIntersection[__nesc_mote];
    *size = sizeof(LeyLine_M$amIntersection[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$addressBroadcasted"))
  {
    *addr = (uintptr_t)&LeyLine_M$addressBroadcasted[__nesc_mote];
    *size = sizeof(LeyLine_M$addressBroadcasted[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$myAddress"))
  {
    *addr = (uintptr_t)&LeyLine_M$myAddress[__nesc_mote];
    *size = sizeof(LeyLine_M$myAddress[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$skipBy"))
  {
    *addr = (uintptr_t)&LeyLine_M$skipBy[__nesc_mote];
    *size = sizeof(LeyLine_M$skipBy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$addressSpace"))
  {
    *addr = (uintptr_t)&LeyLine_M$addressSpace[__nesc_mote];
    *size = sizeof(LeyLine_M$addressSpace[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$tempAddr"))
  {
    *addr = (uintptr_t)&LeyLine_M$tempAddr[__nesc_mote];
    *size = sizeof(LeyLine_M$tempAddr[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$hello"))
  {
    *addr = (uintptr_t)&LeyLine_M$hello[__nesc_mote];
    *size = sizeof(LeyLine_M$hello[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$joinreq"))
  {
    *addr = (uintptr_t)&LeyLine_M$joinreq[__nesc_mote];
    *size = sizeof(LeyLine_M$joinreq[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$rtbroadcast"))
  {
    *addr = (uintptr_t)&LeyLine_M$rtbroadcast[__nesc_mote];
    *size = sizeof(LeyLine_M$rtbroadcast[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$incorpreq"))
  {
    *addr = (uintptr_t)&LeyLine_M$incorpreq[__nesc_mote];
    *size = sizeof(LeyLine_M$incorpreq[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$startLine"))
  {
    *addr = (uintptr_t)&LeyLine_M$startLine[__nesc_mote];
    *size = sizeof(LeyLine_M$startLine[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$leylineAck"))
  {
    *addr = (uintptr_t)&LeyLine_M$leylineAck[__nesc_mote];
    *size = sizeof(LeyLine_M$leylineAck[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$backPropMsg"))
  {
    *addr = (uintptr_t)&LeyLine_M$backPropMsg[__nesc_mote];
    *size = sizeof(LeyLine_M$backPropMsg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$changeSucc"))
  {
    *addr = (uintptr_t)&LeyLine_M$changeSucc[__nesc_mote];
    *size = sizeof(LeyLine_M$changeSucc[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$incorpNode"))
  {
    *addr = (uintptr_t)&LeyLine_M$incorpNode[__nesc_mote];
    *size = sizeof(LeyLine_M$incorpNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$incorpACK"))
  {
    *addr = (uintptr_t)&LeyLine_M$incorpACK[__nesc_mote];
    *size = sizeof(LeyLine_M$incorpACK[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$authSIN"))
  {
    *addr = (uintptr_t)&LeyLine_M$authSIN[__nesc_mote];
    *size = sizeof(LeyLine_M$authSIN[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$SIN"))
  {
    *addr = (uintptr_t)&LeyLine_M$SIN[__nesc_mote];
    *size = sizeof(LeyLine_M$SIN[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$intLineBuiltMsg"))
  {
    *addr = (uintptr_t)&LeyLine_M$intLineBuiltMsg[__nesc_mote];
    *size = sizeof(LeyLine_M$intLineBuiltMsg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$assignAddrMsg"))
  {
    *addr = (uintptr_t)&LeyLine_M$assignAddrMsg[__nesc_mote];
    *size = sizeof(LeyLine_M$assignAddrMsg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$assignAddrComp"))
  {
    *addr = (uintptr_t)&LeyLine_M$assignAddrComp[__nesc_mote];
    *size = sizeof(LeyLine_M$assignAddrComp[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$app_msg_"))
  {
    *addr = (uintptr_t)&LeyLine_M$app_msg_[__nesc_mote];
    *size = sizeof(LeyLine_M$app_msg_[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$p_leyline_msg_"))
  {
    *addr = (uintptr_t)&LeyLine_M$p_leyline_msg_[__nesc_mote];
    *size = sizeof(LeyLine_M$p_leyline_msg_[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$addrBroadcastMsg"))
  {
    *addr = (uintptr_t)&LeyLine_M$addrBroadcastMsg[__nesc_mote];
    *size = sizeof(LeyLine_M$addrBroadcastMsg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$p_app_msg_"))
  {
    *addr = (uintptr_t)&LeyLine_M$p_app_msg_[__nesc_mote];
    *size = sizeof(LeyLine_M$p_app_msg_[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$shortcutTable"))
  {
    *addr = (uintptr_t)&LeyLine_M$shortcutTable[__nesc_mote];
    *size = sizeof(LeyLine_M$shortcutTable[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$dest"))
  {
    *addr = (uintptr_t)&LeyLine_M$dest[__nesc_mote];
    *size = sizeof(LeyLine_M$dest[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$SINnext"))
  {
    *addr = (uintptr_t)&LeyLine_M$SINnext[__nesc_mote];
    *size = sizeof(LeyLine_M$SINnext[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$latestRTFrom"))
  {
    *addr = (uintptr_t)&LeyLine_M$latestRTFrom[__nesc_mote];
    *size = sizeof(LeyLine_M$latestRTFrom[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$onCore"))
  {
    *addr = (uintptr_t)&LeyLine_M$onCore[__nesc_mote];
    *size = sizeof(LeyLine_M$onCore[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$onIntersection"))
  {
    *addr = (uintptr_t)&LeyLine_M$onIntersection[__nesc_mote];
    *size = sizeof(LeyLine_M$onIntersection[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$amCoreLeaf"))
  {
    *addr = (uintptr_t)&LeyLine_M$amCoreLeaf[__nesc_mote];
    *size = sizeof(LeyLine_M$amCoreLeaf[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$leftDone"))
  {
    *addr = (uintptr_t)&LeyLine_M$leftDone[__nesc_mote];
    *size = sizeof(LeyLine_M$leftDone[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$rightDone"))
  {
    *addr = (uintptr_t)&LeyLine_M$rightDone[__nesc_mote];
    *size = sizeof(LeyLine_M$rightDone[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$waitingJoinReq"))
  {
    *addr = (uintptr_t)&LeyLine_M$waitingJoinReq[__nesc_mote];
    *size = sizeof(LeyLine_M$waitingJoinReq[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$SINMode"))
  {
    *addr = (uintptr_t)&LeyLine_M$SINMode[__nesc_mote];
    *size = sizeof(LeyLine_M$SINMode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$waitingforAck"))
  {
    *addr = (uintptr_t)&LeyLine_M$waitingforAck[__nesc_mote];
    *size = sizeof(LeyLine_M$waitingforAck[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$amSrc"))
  {
    *addr = (uintptr_t)&LeyLine_M$amSrc[__nesc_mote];
    *size = sizeof(LeyLine_M$amSrc[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$myNode"))
  {
    *addr = (uintptr_t)&LeyLine_M$myNode[__nesc_mote];
    *size = sizeof(LeyLine_M$myNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$neighborCount"))
  {
    *addr = (uintptr_t)&LeyLine_M$neighborCount[__nesc_mote];
    *size = sizeof(LeyLine_M$neighborCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "LeyLine_M$routingTable"))
  {
    *addr = (uintptr_t)&LeyLine_M$routingTable[__nesc_mote];
    *size = sizeof(LeyLine_M$routingTable[__nesc_mote]);
    return 0;
  }
  ...
  /* Module AMQueueEntryP$14 */

  /* Module AMQueueEntryP$15 */

  /* Module AMQueueEntryP$16 */
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module LeyLine25nodeTestM */
  memset((void *)&LeyLine25nodeTestM$pkt[__nesc_mote], 0, sizeof LeyLine25nodeTestM$pkt[__nesc_mote]);
  memset((void *)&LeyLine25nodeTestM$p_pkt[__nesc_mote], 0, sizeof LeyLine25nodeTestM$p_pkt[__nesc_mote]);
  LeyLine25nodeTestM$src[__nesc_mote] = 0;
  LeyLine25nodeTestM$dest[__nesc_mote] = 0;
  LeyLine25nodeTestM$numberNodes[__nesc_mote] = 100;
  LeyLine25nodeTestM$addressSpace[__nesc_mote] = 100;
  LeyLine25nodeTestM$skipby[__nesc_mote] = 0;
  LeyLine25nodeTestM$myAddress[__nesc_mote] = 0;
  LeyLine25nodeTestM$noTimes[__nesc_mote] = 1;
  LeyLine25nodeTestM$maxTimes[__nesc_mote] = 1;

  /* Module LeyLine_M */
  LeyLine_M$counter[__nesc_mote] = 0;
  LeyLine_M$nodeCount[__nesc_mote] = 1;
  LeyLine_M$busy[__nesc_mote] = FALSE;
  LeyLine_M$starterNode[__nesc_mote] = FALSE;
  LeyLine_M$amIntersection[__nesc_mote] = FALSE;
  LeyLine_M$addressBroadcasted[__nesc_mote] = FALSE;
  LeyLine_M$myAddress[__nesc_mote] = 0;
  LeyLine_M$skipBy[__nesc_mote] = 0;
  LeyLine_M$addressSpace[__nesc_mote] = 100;
  LeyLine_M$tempAddr[__nesc_mote] = 0;
  memset((void *)&LeyLine_M$hello[__nesc_mote], 0, sizeof LeyLine_M$hello[__nesc_mote]);
  memset((void *)&LeyLine_M$joinreq[__nesc_mote], 0, sizeof LeyLine_M$joinreq[__nesc_mote]);
  memset((void *)&LeyLine_M$rtbroadcast[__nesc_mote], 0, sizeof LeyLine_M$rtbroadcast[__nesc_mote]);
  memset((void *)&LeyLine_M$incorpreq[__nesc_mote], 0, sizeof LeyLine_M$incorpreq[__nesc_mote]);
  memset((void *)&LeyLine_M$startLine[__nesc_mote], 0, sizeof LeyLine_M$startLine[__nesc_mote]);
  memset((void *)&LeyLine_M$leylineAck[__nesc_mote], 0, sizeof LeyLine_M$leylineAck[__nesc_mote]);
  memset((void *)&LeyLine_M$backPropMsg[__nesc_mote], 0, sizeof LeyLine_M$backPropMsg[__nesc_mote]);
  memset((void *)&LeyLine_M$changeSucc[__nesc_mote], 0, sizeof LeyLine_M$changeSucc[__nesc_mote]);
  memset((void *)&LeyLine_M$incorpNode[__nesc_mote], 0, sizeof LeyLine_M$incorpNode[__nesc_mote]);
  memset((void *)&LeyLine_M$incorpACK[__nesc_mote], 0, sizeof LeyLine_M$incorpACK[__nesc_mote]);
  memset((void *)&LeyLine_M$authSIN[__nesc_mote], 0, sizeof LeyLine_M$authSIN[__nesc_mote]);
  memset((void *)&LeyLine_M$SIN[__nesc_mote], 0, sizeof LeyLine_M$SIN[__nesc_mote]);
  memset((void *)&LeyLine_M$intLineBuiltMsg[__nesc_mote], 0, sizeof LeyLine_M$intLineBuiltMsg[__nesc_mote]);
  memset((void *)&LeyLine_M$assignAddrMsg[__nesc_mote], 0, sizeof LeyLine_M$assignAddrMsg[__nesc_mote]);
  memset((void *)&LeyLine_M$assignAddrComp[__nesc_mote], 0, sizeof LeyLine_M$assignAddrComp[__nesc_mote]);
  memset((void *)&LeyLine_M$app_msg_[__nesc_mote], 0, sizeof LeyLine_M$app_msg_[__nesc_mote]);
  memset((void *)&LeyLine_M$p_leyline_msg_[__nesc_mote], 0, sizeof LeyLine_M$p_leyline_msg_[__nesc_mote]);
  memset((void *)&LeyLine_M$addrBroadcastMsg[__nesc_mote], 0, sizeof LeyLine_M$addrBroadcastMsg[__nesc_mote]);
  memset((void *)&LeyLine_M$p_app_msg_[__nesc_mote], 0, sizeof LeyLine_M$p_app_msg_[__nesc_mote]);
  memset((void *)&LeyLine_M$shortcutTable[__nesc_mote], 0, sizeof LeyLine_M$shortcutTable[__nesc_mote]);
  memset((void *)&LeyLine_M$dest[__nesc_mote], 0, sizeof LeyLine_M$dest[__nesc_mote]);
  LeyLine_M$SINnext[__nesc_mote] = 0;
  LeyLine_M$latestRTFrom[__nesc_mote] = 0;
  LeyLine_M$onCore[__nesc_mote] = FALSE;
  LeyLine_M$onIntersection[__nesc_mote] = FALSE;
  LeyLine_M$amCoreLeaf[__nesc_mote] = FALSE;
  LeyLine_M$leftDone[__nesc_mote] = FALSE;
  LeyLine_M$rightDone[__nesc_mote] = FALSE;
  LeyLine_M$waitingJoinReq[__nesc_mote] = FALSE;
  LeyLine_M$SINMode[__nesc_mote] = FALSE;
  LeyLine_M$waitingforAck[__nesc_mote] = FALSE;
  LeyLine_M$amSrc[__nesc_mote] = FALSE;
  memset((void *)&LeyLine_M$myNode[__nesc_mote], 0, sizeof LeyLine_M$myNode[__nesc_mote]);
  memset((void *)&LeyLine_M$neighborCount[__nesc_mote], 0, sizeof LeyLine_M$neighborCount[__nesc_mote]);
  memset((void *)&LeyLine_M$routingTable[__nesc_mote], 0, sizeof LeyLine_M$routingTable[__nesc_mote]);
  ...
  /* Module AMQueueImplP$0 */
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[__nesc_mote] = 17;
